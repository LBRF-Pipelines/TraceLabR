...
# TO DO: RATHER THAN PLOT FACET BY SESSION, MUST FACET BY BLOCK
# AND HIDE FIRST SESSION IF IMAGERY
...
part.dat <- all_data[all_data$participant==part_num,]
part.dat <- part.dat[part.dat$figure=='repeated',]
