...
if(nrow(trials)==0){
        ...
        for(i in 1:length(file.names)) {
                ...
                # determine group, and run appropriate analysis
                if(trials[trials$figure_file==name.tlf,5]=='MI-00-5'){
                ...
                else if(trials[trials$figure_file==name.tlf,5]=='CC-00-5'){
                        # finds sessions 1 to 4:
                        if(trials[trials$figure_file==name.tlf,4]!=5){
